...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    siteName: 'Florestone',
    images: [{ url: 'https://www.florestone.com/images/bases/saflor/lifestyle/florestone-saflor-3660-1-base-wht-shot01-deco-w.jpg', width: 1200, height: 900, alt: 'Florestone S Series recess shower base' }],
    type: 'website',
  },
};
