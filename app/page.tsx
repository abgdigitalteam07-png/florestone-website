          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-white/60 text-[15px] leading-relaxed mb-8 max-w-md">
                Florestone started with cement laundry trays in Oakland in 1947. By 1965, we pioneered compression-molded shower receptors that became the American construction standard. Today we manufacture at two US plants — closed mold fiberglass F Series and cast terrazzo from Madera, CA; compression-molded S Series from Denison, TX. Every unit still made in America to trade-spec standards.
              </p>
